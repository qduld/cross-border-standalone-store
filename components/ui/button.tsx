...
const Button = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  ({ className, variant = 'default', size = 'default', ...props }, ref) => {
    const variants = {
      ...
      outline: 'border-2 border-red-700 text-red-700 hover:bg-red-50 hover:scale-105 transition-all duration-200 dark:border-gray-600 dark:text-white dark:hover:bg-gray-700',
      ghost: 'hover:bg-red-50 hover:text-red-700 transition-all duration-200 dark:hover:bg-gray-700 dark:hover:text-white',
      link: 'text-red-700 hover:underline underline-offset-4 transition-all duration-200 dark:text-red-400',
